...
export class Team {
    ...
    constructor(teamName: string,
                ...
                matchRecords : MatchRecords = new MatchRecords(UInt64.from(0),UInt64.from(0),UInt64.from(0),UInt64.from(0),UInt64.from(0),UInt64.from(0),UInt64.from(0)))
      {
    ...
    positioning(x: number, y: number, player: Player){
      ...
      if (((x<70)&&(x>0))&&((y<70)&&(y>0))){
        if (((x<20)&&(x>0))&&((y<10)&&(y>0))||((x<70)&&(x>50))&&((y<10)&&(y>0))){
          console.log("You can not put your Player here.")
        }
